package com.company.simplesavings.presentValue;

import com.company.simplesavings.interestRate.InterestRate;
import com.company.simplesavings.presentValue.controllers.PresentValueController;
...
public class PresentValue {
    ...
    public static void displayPresentValueCalculator( Stage savingsCalculator, Scene mainScene, Scene simpleSavingsScene) {

        savingsCalculator.setTitle("Simple Savings Calculator - Present Value");
        ...
        fvButton.setOnAction(e -> {
            savingsCalculator.setTitle("Finance Calculator - Time in Years Calculator");
        ...
        // Future Value.
        Label futureValue = new Label("PV (Present Value) : $ ");
        ...
        calculateButton.setOnAction(e -> PresentValueController.calculateSavings(futureValueTextField, interestRateTextField, yearsTimeTextField, futureValue));
        ...
        clearButton.setOnAction(e -> TimeController.clearTextFields(futureValueTextField, interestRateTextField, yearsTimeTextField));
        ...
        dataEnteringSection.getChildren().addAll(fvButton, iRButton, pVButton, tButton, futureValueLabel, futureValueTextField, interestRateLabel, interestRateTextField, yearsTimeLabel, yearsTimeTextField, percentageMarkLabel, calculateButton);
        ...
        Scene presentValue = new Scene(rootSavingsCalculator, 1280, 900);
        presentValue.getStylesheets().add("Stylesheet.css");
        savingsCalculator.setScene(presentValue);
