package com.company.compoundinterest.AnnuityPayment;
...
public class AnnuityPayment{
    ...
    public static void displayAnnuityPayment(Stage savingsCalculator, Scene mainScene, Scene compoundInterestScene) {
        savingsCalculator.setTitle("Finance Calculator - Annuity Payment");
        ...
        startPrincipalButton.setOnAction(e -> StartingPrincipal.displayStartingPrincipal(savingsCalculator, mainScene, compoundInterestScene));
        ...
        AnchorPane.setTopAnchor(startPrincipalLabel, 164.0);
        ...
        AnchorPane.setTopAnchor(startPrincipalTextField, 167.0);
        ...
        AnchorPane.setTopAnchor(interestLabel, 211.0);
        ...
        calculateButton.setOnAction(e -> {
            AnnuityPaymentController.calculateSavings(futureValueTextField, noPeriodsTextField, startPrincipalTextField, interestTextField, futureValue, presentValue, numberPeriods ,interestRate, periodicPayment, startingInvestmentLabel, totalPrincipal, totalInterest);
            //
        });
        ...
        clearButton.setOnAction(e -> AnnuityPaymentController.clearTextFields(futureValueTextField, noPeriodsTextField, startPrincipalTextField, interestTextField));
        ...
        Scene annuityPaymentScene = new Scene(rootSavingsCalculator, 1280, 900);
        annuityPaymentScene.getStylesheets().add("Stylesheet.css");
        savingsCalculator.setScene(annuityPaymentScene);
