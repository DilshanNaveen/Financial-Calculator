...
import com.company.loancalculator.controllers.LoanCalculatorController;
import com.company.loancalculator.totalprice.TotalPrice;
...
public class LoanCalculator{
    ...
    public static void displayLoanCalculator(Stage savingsCalculator, Scene mainScene){
        ...
        Scene loanCalculatorScene = new Scene(rootSavingsCalculator, 1280, 900);
        ...
        totalPriceButton.setOnAction(e -> TotalPrice.displayTotalPriceCalculator(savingsCalculator, mainScene, loanCalculatorScene));
        ...
        AnchorPane.setTopAnchor(monthlyPayLabel, 75.0);
        AnchorPane.setLeftAnchor(monthlyPayLabel, 20.0);

        // Monthly Pay TextField.
        TextField monthlyPayTextField = new TextField();
        monthlyPayTextField.setOnMouseClicked(e -> selectTextField(monthlyPayTextField));
        AnchorPane.setTopAnchor(monthlyPayTextField, 70.0);
        AnchorPane.setLeftAnchor(monthlyPayTextField, 180.0);
        AnchorPane.setRightAnchor(monthlyPayTextField, 20.0);
        ...
        // Vehicle Price Label.
        Label vehiclePriceLabel = new Label("Vehicle Price : $");
        AnchorPane.setTopAnchor(vehiclePriceLabel, 69.0);
        AnchorPane.setLeftAnchor(vehiclePriceLabel, 30.0);
        ...
        // Action
        calculateButton.setOnAction(e -> LoanCalculatorController.calculateLoan(monthlyPayTextField, loanTermsTextField, interestTextField, downPaymentTextField, tradePaymentTextField, salesTaxTextField, otherFeesTextField, vehiclePriceLabel, totalLoanAmountLabel, saleTaxLabel, upfrontPaymentLabel, totalLoanPaymentsLabel, totalLoanInterestLabel, totalCostLabel));
        ...
        clearButton.setOnAction(e -> LoanCalculatorController.clearTextFields(monthlyPayTextField, loanTermsTextField, interestTextField, downPaymentTextField, tradePaymentTextField, salesTaxTextField, otherFeesTextField));
        ...
        dataEnteringSection.getChildren().addAll(monthlyPaymentButton, totalPriceButton, monthlyPayLabel, monthlyPayTextField, loanTermsLabel, loanTermsTextField, interestLabel, interestTextField, percentageMarkLabel, downPaymentLabel, downPaymentTextField, tradedValueLabel, tradePaymentTextField, salesTaxLabel, salesTaxTextField, percentageMarkSalesLabel, otherFeesLabel, otherFeesTextField, calculateButton);
        dataEnteringSection.getStyleClass().add("section-style");

        resultSection.getChildren().addAll(resultsLabel, vehiclePriceLabel, totalLoanAmountLabel, saleTaxLabel, upfrontPaymentLabel, totalLoanPaymentsLabel, totalLoanInterestLabel, totalCostLabel);
        ...
        loanCalculatorScene.getStylesheets().add("Stylesheet.css");
